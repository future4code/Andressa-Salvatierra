...
const changePassword_1 = require("../../../business/usecase/user/changePassword");
...
exports.changePasswordEndpoint = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uc = new changePassword_1.ChangePasswordUC(new userDB_1.UserDB(), new jwtAuthorizer_1.JwtAuthorizer(), new bcryptService_1.BcryptService());
